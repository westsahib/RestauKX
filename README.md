...
| [Tech Stack](./docs/TECH-STACK.md) | Every technology choice — and every alternative that was considered and rejected |
| [Contributing](./docs/CONTRIBUTING.md) | Branching strategy, commit conventions, code style |
